...
public class FilmContract {
    ...
    public static final class FilmEntry implements BaseColumns {
        ...
        public static Uri buildReviewContentUriWithId(String id){
            return CONTENT_URI.buildUpon().appendPath(id).appendPath(Utility.PATH_REVIEW).build();
        }

        public static Uri buildTrailerContentUriWithId(String id){
            return CONTENT_URI.buildUpon().appendPath(id).appendPath(Utility.PATH_TRAILER).build();
        }
    }
}
